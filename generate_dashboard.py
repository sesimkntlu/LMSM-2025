...
def process_data(raw_data, column_mapping):
    ...
    school_level_chart_data = [school_level_counts[label] for label in school_level_chart_labels]
...
def generate_html_dashboard(dashboard_data, background_image_url=None):
    ...
    <body class="min-h-screen p-6 text-gray-800"> <header class="text-center mb-10">
            <h1 class="text-5xl font-extrabold text-indigo-800 mb-2 rounded-lg p-2 shadow-sm">
                Relatóriu Atuál Progresu Rejistrasaun Selebrasaun LMSM 2025
            </h1>
            <p class="text-lg font-extrabold text-indigo-600">SESIM-KNTLU</p>
        </header>
        ...
        <section class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8"> <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 flex flex-col items-center justify-center">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Munisípiu</h2>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 flex flex-col items-center justify-center">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Seksu</h2>
                <p id="totalGender" class="text-5xl font-extrabold text-purple-600"></p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 flex flex-col items-center justify-center">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Dixiplina</h2>
                <p id="totalDiscipline" class="text-5xl font-extrabold text-purple-600"></p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 flex flex-col items-center justify-center">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Tópiku LMSM 2025</h2> <p id="totalTopiku" class="text-5xl font-extrabold text-purple-600"></p>
            </div>
        </section>
        ...
        <section id="summary-section" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-10">
            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Persentajen bazeia ba Jéneru</h2>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                <h2 class="text-2xl font-bold text-indigo-700 mb-3">Númeru Tópiku kada Dixiplina</h2>
                <div class="chart-container">
        ...
        <section class="bg-white p-6 rounded-xl shadow-lg mb-10">
            ...
            <div id="detailed-table-container" class="overflow-x-auto rounded-lg border border-gray-200 shadow-md">
                </div>
        </section>
        ...
        <script>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-blue-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">Naran Kanorin</th>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">Títulu/Tópiku</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">Dokumentu</th>
                            </tr>
                        </thead>
                    ...
                    filteredData.forEach(row => {{
                        tableHtml += `
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${{row['Naran Kanorin']}}</td>
            ...
            function renderFilterOptions() {{
                const filterSelect = document.getElementById('nivelEskolaFilter');
                filterSelect.innerHTML = ''; // Hamoos Opsaun sira ne'ebé eziste
                ...
                filterSelect.addEventListener('change', (event) => {{
                    renderDetailedTable(event.target.value);
                }});
            }}
